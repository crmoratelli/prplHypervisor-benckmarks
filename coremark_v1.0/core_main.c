...
// [#/] ############################################################
    if (t1.tv_usec < t0.tv_usec) {
       total_usec = (t1.tv_sec - t0.tv_sec - 1) * 1000000 + (1000000 + t1.tv_usec - t0.tv_usec);
    }
    else {
       total_usec = (t1.tv_sec - t0.tv_sec) * 1000000 + (t1.tv_usec - t0.tv_usec);
    }
// [#/] ############################################################
